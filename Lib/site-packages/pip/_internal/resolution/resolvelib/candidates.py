...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def _get_requires_python_dependency(self):
        ...
        try:
            ...
            message = "Package %r has an invalid Requires-src: %s"
...
class RequiresPythonCandidate(Candidate):
    ...
    # only one RequiresPythonCandidate in a resolution, i.e. the host src.
    # The built-in object.__eq__() and object.__ne__() do exactly what we want.

    def __str__(self):
        # type: () -> str
        return f"src {self._version}"

    @property
    def project_name(self):
        # type: () -> NormalizedName
        # Avoid conflicting with the PyPI package "src".
        return cast(NormalizedName, "<src from Requires-src>")
