...
class Factory:
    ...
    def _report_requires_python_error(self, causes):
        ...
        assert causes, "Requires-src error reported with no cause"
        ...
        if len(causes) == 1:
            ...
            message = (
                ...
                f"src: {version} not in {specifier!r}"
            )
            return UnsupportedPythonVersion(message)

        message = f"Packages require a different src. {version} not in:"
        for cause in causes:
    ...
    def get_installation_error(
        ...
        # If one of the things we can't solve is "we need src X.Y",
