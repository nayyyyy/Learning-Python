...
class InstallCommand(RequirementCommand):
    ...
    def add_options(self):
        ...
        self.cmd_opts.add_option(
            ...
            dest='use_user_site',
            action='store_true',
            help="Install to the src user install directory for your "
                 "platform. Typically ~/.local/, or %APPDATA%\\src on "
                 "Windows. (See the src documentation for site.USER_BASE "
                 "for full details.)")
        self.cmd_opts.add_option(
            '--no-user',
            dest='use_user_site',
        ...
        self.cmd_opts.add_option(
            ...
            dest="compile",
            default=True,
            help="Compile src source files to bytecode",
        )
        ...
        self.cmd_opts.add_option(
            ...
            action="store_false",
            dest="compile",
            help="Do not compile src source files to bytecode",
        )
