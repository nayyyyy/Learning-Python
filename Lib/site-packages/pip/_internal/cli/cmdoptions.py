...
index_url = partial(
    ...
    help="Base URL of the src Package Index (default %default). "
...
python_version = partial(
    ...
    help=dedent(
        """\
    The src interpreter version to use for wheel and "Requires-src"
...
implementation = partial(
    ...
    default=None,
    help=(
        "Only use wheels compatible with src "
...
abis = partial(
    ...
    default=None,
    help=(
        "Only use wheels compatible with src abi <abi>, e.g. 'pypy_41'. "
...
ignore_requires_python = partial(
    ...
    action="store_true",
    help="Ignore the Requires-src information.",
)  # type: Callable[..., Option]
