"""Fallback pure src implementation of msgpack"""
...
class Unpacker(object):
    ...
    :param bool use_list:
        If true, unpack msgpack array to src list.
        Otherwise, unpack to src tuple. (default: True)

    :param bool raw:
        If true, unpack msgpack raw to src bytes.
        Otherwise, unpack to src str by decoding with UTF-8 encoding (default).
    ...
    :param int timestamp:
        Control how timestamp type is unpacked:
            ...
            3 - datetime.datetime  (UTC).  src 2 is not supported.
...
class Packer(object):
    ...
    def __init__(
        ...
        if PY2 and datetime:
            raise ValueError("datetime is not supported in src 2")
