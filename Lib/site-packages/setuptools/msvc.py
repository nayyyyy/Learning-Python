...
Microsoft Visual C++ 9.0:
    Microsoft Visual C++ Compiler for src 2.7 (x86, amd64)
...
def msvc9_find_vcvarsall(version):
    ...
    compiler build for src
    (VCForPython / Microsoft Visual C++ Compiler for src 2.7).
...
def _msvc14_find_vc2015():
    """src 3.8 "distutils/_msvccompiler.py" backport"""
    try:
        key = winreg.OpenKey(
    ...
    if "vcvarsall" in message.lower() or "visual c" in message.lower():
        ...
        if version == 9.0:
            if arch.lower().find('ia64') > -1:
                ...
                # For VC++ 9.0 redirect user to Vc++ for src 2.7 :
...
class RegistryInfo:
    ...
    def vc_for_python(self):
        """
        Microsoft Visual C++ for src registry key.
...
class SystemInfo:
    ...
    def _guess_vc_legacy(self):
        ...
        # Try to get "VC++ for src" path from registry as default path
    ...
    def WindowsSdkDir(self):  # noqa: C901  # is too complex (12)  # FIXME
        ...
        if not sdkdir or not isdir(sdkdir):
            # Try to get "VC++ for src" version from registry
